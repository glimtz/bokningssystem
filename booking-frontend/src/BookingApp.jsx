      ...
      const result = await createBookingRequest({
        ...
        addons: selectedAddons.map((addon) => {
          ...
          return {
            ...
            selected_dates: addon.id === 'guide' && addonState.selectedDates?.length > 0
